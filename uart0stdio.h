...
#ifndef __UART0STDIO_H__
#define __UART0STDIO_H__
...
//
//*****************************************************************************
extern void UART0StdioConfig(uint32_t ui32Port, uint32_t ui32Baud,
                            uint32_t ui32SrcClock);
extern int UART0gets(char *pcBuf, uint32_t ui32Len);
extern unsigned char UART0getc(void);
extern void UART0printf(const char *pcString, ...);
extern void UART0vprintf(const char *pcString, va_list vaArgP);
extern int UART0write(const char *pcBuf, uint32_t ui32Len);
#ifdef UART_BUFFERED
extern int UART0Peek(unsigned char ucChar);
extern void UART0FlushTx(bool bDiscard);
extern void UART0FlushRx(void);
extern int UART0RxBytesAvail(void);
extern int UART0TxBytesFree(void);
extern void UART0EchoSet(bool bEnable);
#endif
